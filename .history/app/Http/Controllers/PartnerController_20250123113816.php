    ...
    public function update(Request $req, $id)
    {
        try {
            ...
            $validatedData = $req->validate([
                ...
                'description' => ['required', 'string'], // Assuming you might want to update description as well
                'logo' => ['required', 'string'] // Optional, assuming you want to handle logo as well
            ]);
